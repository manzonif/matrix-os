...
module.exports = {
  ...
  read: function(buffer) {
    debug('read>', new Matrix.service.protobuf.vision.v1.vision.VisionResult.decode(buffer).toRaw());
    var detect = new Matrix.service.protobuf.vision.v1.vision.VisionResult.decode(buffer).toRaw();
  ...
  prepare: function(options, cb) {
    ...
    var camConfig = new Matrix.service.protobuf.malos.v1.driver.CameraConfig;
    camConfig.set_camera_id(0);
    camConfig.set_width(640);
    camConfig.set_height(480);

    driverConfigProto.malos_eye_config = new Matrix.service.protobuf.malos.v1.driver.MalosEyeConfig;
    driverConfigProto.malos_eye_config.create({ cameraConfig: camConfig });
  ...
  config: function(options) {
    ...
    var config = new Matrix.service.protobuf.malos.v1.driver.DriverConfig;
    config.malos_eye_config = new Matrix.service.protobuf.malos.v1.driver.MalosEyeConfig;

    // send config
    config.malos_eye_config.object_to_detect.push(Matrix.service.protobuf.malos.v1.driver.EnumMalosEyeDetectionType[options.enumName]);
    config.malos_eye_config.object_to_detect.push(Matrix.service.protobuf.malos.v1.driver.EnumMalosEyeDetectionType.FACE_DESCRIPTOR);
