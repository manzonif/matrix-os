...
function clear() {
  var config = new builders.driver.DriverConfig;
  config.image = new builders.io.EverloopImage;

  for (var i = 0; i < 35; i++) {
    var led = new builders.io.LedValue;
    led.setRed(0);
    led.setGreen(0);
    led.setBlue(0);
    led.setWhite(0);
...
module.exports = {
  ...
  init: function() {
    ...
    builders = {
      ...
      io: Matrix.service.protobuf.malos.driver.build('matrix_io.malos.v1.io'),
