...
module.exports = {
  ...
  init: function() {
    ...
    var protoRecognitionBuilder = Matrix.service.protobuf.recognition.recognition;
    var protoRecognitionServiceBuilder = Matrix.service.protobuf.recognition.recognition_service;
    matrixVision = protoVisionBuilder.build('matrix_io.vision.v1');
    matrixRecognition = protoRecognitionBuilder.build('matrix_io.recognition.v1');
    matrixRecognitionService = protoRecognitionServiceBuilder.build('matrix_io.recognition.v1');
    protoMalosBuilder = Matrix.service.protobuf.malos.driver;
    matrixMalos = protoMalosBuilder.build('matrix_io.malos.v1.driver');
    matrixRPC = Matrix.service.protobuf.recognition.recognition_service;
