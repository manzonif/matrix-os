var matrixMalosBuilder, driverConfig, ZB, Cmd;
...
module.exports = {
  ...
  init: function() {
    ...
    // Parse package (namespace).
    var builders = {
      driver: Matrix.service.protobuf.malos.driver.build('matrix_io.malos.v1.driver'),
      comm: Matrix.service.protobuf.malos.comm.build('matrix_io.malos.v1.comm')
    }
    // Command Constructor
    ZB = function() {
      // start from fresh object
      var self = this;     
      self.config = new builders.driver.DriverConfig;

      var cmds = {};
      cmds.msg = new builders.comm.ZigBeeMsg;
      cmds.net = new builders.comm.ZigBeeMsg.NetworkMgmtCmd;
      cmds.zcl = new builders.comm.ZigBeeMsg.ZCLCmd;
      cmds.id = new builders.comm.ZigBeeMsg.ZCLCmd.IdentifyCmd;
      cmds.onoff = new builders.comm.ZigBeeMsg.ZCLCmd.OnOffCmd;
      cmds.level = new builders.comm.ZigBeeMsg.ZCLCmd.LevelCmd;
      cmds.colorcontrol = new builders.comm.ZigBeeMsg.ZCLCmd.ColorControlCmd;

      var params = {};
      params.movetohue = new builders.comm.ZigBeeMsg.ZCLCmd.ColorControlCmd.MoveToHueCmdParams;
      params.movetolevel = new builders.comm.ZigBeeMsg.ZCLCmd.LevelCmd.MoveToLevelCmdParams;
      params.movelevel = new builders.comm.ZigBeeMsg.ZCLCmd.LevelCmd.MoveCmdParams;
      params.movetohueandsat = new builders.comm.ZigBeeMsg.ZCLCmd.ColorControlCmd.MoveToHueAndSatCmdParams;
      params.movetosat = new builders.comm.ZigBeeMsg.ZCLCmd.ColorControlCmd.MoveToHueCmdParams;
      params.permitJoin = new builders.comm.ZigBeeMsg.NetworkMgmtCmd.PermitJoinParams;

      // enums need to be referenced outside of ZB
      enums.netStatus = builders.comm.ZigBeeMsg.NetworkMgmtCmd.NetworkStatus.Status;
      enums.netTypes = builders.comm.ZigBeeMsg.NetworkMgmtCmd.NetworkMgmtCmdTypes;
      enums.zbCmdTypes = builders.comm.ZigBeeMsg.ZigBeeCmdType;
      enums.idCmdTypes = builders.comm.ZigBeeMsg.ZCLCmd.IdentifyCmd.ZCLIdentifyCmdType;
      enums.mdTypes = builders.comm.ZigBeeMsg.ZigBeeCmdType;
      enums.onoff = builders.comm.ZigBeeMsg.ZCLCmd.OnOffCmd.ZCLOnOffCmdType;
      enums.level = builders.comm.ZigBeeMsg.ZCLCmd.LevelCmd.ZCLLevelCmdType;
      enums.zclCmdTypes = builders.comm.ZigBeeMsg.ZCLCmd.ZCLCmdType;
  ...
  read: function(buffer) {
    ...
    var zbMsg = new builders.comm.ZigBeeMsg.decode(buffer);
